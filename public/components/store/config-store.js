...
function updProduct($a){
     ...
     if(nCategory==""){
          ...
          var min_list_1 =  $('#min_list_1').val();
          var min_list_2 =  $('#min_list_2').val();
          var min_list_3 =  $('#min_list_3').val();
          var min_list_4 =  $('#min_list_4').val();
          var min_list_5 =  $('#min_list_5').val();
          ...
          if(nPriceProduct=="" || nPriceProduct==0){
               ...
               $.ajax({
                    ...
                    data:{
                         ...
                         nPriceComerce_:nPriceComerce,
                         nPriceProduct_:nPriceProduct,
                         nPricelist3: nPricelist3,
                         nPricelist4: nPricelist4,
                         nPricelist5: nPricelist5,
                         min_list_1: min_list_1,
                         min_list_2: min_list_2,
                         min_list_3: min_list_3,
                         min_list_4: min_list_4,
                         min_list_5: min_list_5
                    },
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    success: function(data){
                        alert(data);
...
function saveNewAttrModal($a){
     ...
     var cstateProduct = $('#stateProductVar').val();
     ...
     var nPricelistVar3 =  $('#nPricelistVar3').val();
     var nPricelistVar4 =  $('#nPricelistVar4').val();
     var nPricelistVar5 =  $('#nPricelistVar5').val();
     
     var min_list_var_1 =  $('#min_list_var_1').val();
     var min_list_var_2 =  $('#min_list_var_2').val();
     var min_list_var_3 =  $('#min_list_var_3').val();
     var min_list_var_4 =  $('#min_list_var_4').val();
     var min_list_var_5 =  $('#min_list_var_5').val();

     var isOffers = $('#isOfferVar').val()
     $.ajax({
          type:'POST',
          ...
          data:{
               ...
               nPricelistVar3: nPricelistVar3,
               nPricelistVar4: nPricelistVar4,
               nPricelistVar5: nPricelistVar5,
               min_list_var_1: min_list_var_1,
               min_list_var_2: min_list_var_2,
               min_list_var_3: min_list_var_3,
               min_list_var_4: min_list_var_4,
               min_list_var_5: min_list_var_5
          },
          headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
          success: function(data){
              alert(data);
...
$('#onlyPublic').on('click', function(){
     let val = $(this).hasClass('active')
     console.log(val)
     if(val === false){
          $('#nPriceProduct').attr('required', true)
          $('#nPriceProduct').attr('min', 1)
          $('#inputOnlyPublic').val(1)
     }
     if(val === true){
          $('#nPriceProduct').removeAttr('required')
          $('#nPriceProduct').removeAttr('min')
          $('#inputOnlyPublic').val(0)
     }
})

$('#onlyComerce').on('click', function(){
     let val = $(this).hasClass('active')
     console.log(val)
     if(val === false){
          $('#nPriceComerce').attr('required', true)
          $('#nPriceComerce').attr('min', 1)
          $('#inputOnlyComerce').val(1)
     }
     if(val === true){
          $('#nPriceComerce').removeAttr('required')
          $('#nPriceComerce').removeAttr('min')
          $('#inputOnlyComerce').val(0)
     }
})

$('body').on('click','#onlyPublicVar', function(){
     let val = $(this).hasClass('active')
     console.log(val)
     if(val === false){
          $('#nPriceProductVar').attr('required', true)
          $('#nPriceProductVar').attr('min', 1)
          $('#inputOnlyPublicVar').val(1)
     }
     if(val === true){
          $('#nPriceProductVar').removeAttr('required')
          $('#nPriceProductVar').removeAttr('min')
          $('#inputOnlyPublicVar').val(0)
     }
})

$('body').on('click', '#onlyComerceVar', function(){
     let val = $(this).hasClass('active')
     console.log(val)
     if(val === false){
          $('#nPriceComerceVar').attr('required', true)
          $('#nPriceComerceVar').attr('min', 1)
          $('#inputOnlyComerceVar').val(1)
     }
     if(val === true){
          $('#nPriceComerceVar').removeAttr('required')
          $('#nPriceComerceVar').removeAttr('min')
          $('#inputOnlyComerceVar').val(0)
     }
})
